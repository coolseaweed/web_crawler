...
class BotSpider(scrapy.Spider):
    ...
    def declare_xpath(self):
        ...
        self.button_entire_xpath = '//*[@class="a-button o-magazineContent__moreButton"]'
    ...
    def parse(self, response):
        ...
        target = f'{os.path.basename(base_url)}_url.list'
        text_path = f'text/crawled_{os.path.basename(base_url)}.txt'
